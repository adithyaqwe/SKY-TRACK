...
const getAircraftIcon = (heading, isSelected) => {
  ...
  const svgTemplate = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" 
         style="transform: rotate(${rotation}deg); filter: ${isSelected ? 'drop-shadow(0 0 8px rgba(56, 189, 248, 0.8))' : 'none'};">
      <path fill="${isSelected ? '#38BDF8' : '#7DD3FC'}" 
            stroke="${isSelected ? '#FFFFFF' : '#020617'}" stroke-width="1"
